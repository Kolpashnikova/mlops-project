...
def run_download_files():        
    # Download the file
    response = client_spaces.get_object(Bucket='mlops-project', Key='data/atus37.parquet')

    # Save the file locally
    with open("data/atus37.parquet", 'wb') as file:
    ...
    response_2 = client_spaces.get_object(Bucket='mlops-project', Key='output/train.pkl')

    with open("output/train.pkl", 'wb') as file:
        file.write(response_2['Body'].read())

    response_3 = client_spaces.get_object(Bucket='mlops-project', Key='output/val.pkl')

    with open("output/val.pkl", 'wb') as file:
        file.write(response_3['Body'].read())
